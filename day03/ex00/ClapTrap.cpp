...
/*   Updated: 2021/12/06 02:16:23 by hgrissen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
            ...
            {
                std::cout << this->name << " is alive and in town looking for some asses to kick !!" << std::endl;
                this->hp = 10;
                this->ep = 10;
                this->ad = 0;
            }
            ...
            ClapTrap::~ClapTrap()
            {
                std::cout << this->name << " has said : \"adious\" !!" << std::endl;
            }
...
*/
            ...
            {
                std::cout << this->name << " attack " << target << ", causing " << this->ad << " points of damage!" << std::endl;
            }
